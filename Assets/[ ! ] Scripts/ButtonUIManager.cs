...
public class ButtonUIManager : MonoBehaviour
{
    ...
    private string Add25Gems_ID = "com.OutbreakCompany.Fall2Live.25gemspack";
    private string Add75Gems_ID = "com.OutbreakCompany.Fall2Live.75gemspack";
    private string Add150Gems_ID = "com.OutbreakCompany.Fall2Live.150gemspack";
    private string Add250Gems_ID = "com.OutbreakCompany.Fall2Live.250gemspack";
    private string Add700Gems_ID = "com.OutbreakCompany.Fall2Live.700gemspack";

    [Header("Subscriptions")]
    private string SubX2CoinsDaily_ID = "com.OutbreakCompany.Fall2Live.subx2coinsdaily";
    private string SubX2CoinsWeekly_ID = "com.OutbreakCompany.Fall2Live.subx2coinsweekly";
    private string SubX2CoinsMonthly_ID = "com.OutbreakCompany.Fall2Live.subx2coinsmonthly";
