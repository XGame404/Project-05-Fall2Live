...
public static class GameDataManager
{
    ...
    {
        BinarySerializer.Save(playerData, "Fall2Live-data-1.txt");
    ...
    static void LoadPlayerData()
    {
        try
        {  
            if (BinarySerializer.HasSaved("Fall2Live-data-1.txt"))
            {
                playerData = BinarySerializer.Load<PlayerData>("Fall2Live-data-1.txt");
